...
trait Logging {
  ...
  def trace(format: => String, arg1: => Any, arg2: => Any) = {
    if (logger.isTraceEnabled())
      logger.trace(msgWithLogIdent(format), arg1, arg2)
  }
  ...
  def debug(format: => String, arg1: => Any, arg2: => Any) = {
    if (logger.isDebugEnabled())
      logger.debug(msgWithLogIdent(format), arg1, arg2)
  }
  def debug(format: => String, arguments: (Unit => Any)*) = {
    if (logger.isDebugEnabled())
      logger.debug(msgWithLogIdent(format), arguments :_*)
  }
  ...
  def info(format: => String, arg1: => Any, arg2: => Any) = {
    logger.info(msgWithLogIdent(format), arg1, arg2)
  }
  def info(format: => String, arguments: (Unit => Any)*) = {
    if (logger.isInfoEnabled())
      logger.info(msgWithLogIdent(format), arguments :_*)
  }
  ...
  def warn(format: => String, arg1: => Any, arg2: => Any) = {
    logger.warn(msgWithLogIdent(format), arg1, arg2)
  }
  def warn(format: => String, arguments: (Unit => Any)*) = {
    if (logger.isWarnEnabled())
      logger.warn(msgWithLogIdent(format), arguments :_*)
  }
  ...
  def error(format: => String, arg1: => Any, arg2: => Any) = {
    logger.error(msgWithLogIdent(format), arg1, arg2)
  }
  def error(format: => String, arguments: (Unit => Any)*) = {
    if (logger.isErrorEnabled())
      logger.error(msgWithLogIdent(format), arguments :_*)
  }
