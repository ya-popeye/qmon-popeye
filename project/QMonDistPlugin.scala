...
object QMonDistPlugin extends Plugin {
  ...
  val dist = TaskKey[File]("dist", "Builds an Qmon Distribution directory")
  val distClean = TaskKey[Unit]("clean", "Removes Qmon Distribution directory")
  ...
  val distJvmOptions = SettingKey[String]("dist-jvm-options",
    "JVM parameters to use in start script")
  val distMainClass = SettingKey[String]("dist-main-class",
    "main class to use in start script")
